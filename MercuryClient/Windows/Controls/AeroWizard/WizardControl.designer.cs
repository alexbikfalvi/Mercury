namespace DotNetApi.Windows.Controls.AeroWizard
{
	partial class WizardControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.contentArea = new DotNetApi.Windows.Controls.ThemedTableLayoutPanel();
			this.pageContainer = new DotNetApi.Windows.Controls.AeroWizard.WizardPageContainer();
			this.backButton = new DotNetApi.Windows.Controls.AeroWizard.ThemedImageButton();
			this.cancelButton = new System.Windows.Forms.Button();
			this.nextButton = new System.Windows.Forms.Button();
			this.header = new DotNetApi.Windows.Controls.ThemedTableLayoutPanel();
			this.headerLabel = new System.Windows.Forms.Label();
			this.commandArea = new DotNetApi.Windows.Controls.ThemedTableLayoutPanel();
			this.titleBar = new DotNetApi.Windows.Controls.ThemedTableLayoutPanel();
		...
		private DotNetApi.Windows.Controls.ThemedTableLayoutPanel titleBar;
		private DotNetApi.Windows.Controls.ThemedTableLayoutPanel header;
		internal System.Windows.Forms.Label headerLabel;
		private DotNetApi.Windows.Controls.ThemedTableLayoutPanel commandArea;
		private System.Windows.Forms.Button cancelButton;
		internal System.Windows.Forms.Button nextButton;
		private DotNetApi.Windows.Controls.AeroWizard.ThemedLabel title;
		private DotNetApi.Windows.Controls.AeroWizard.ThemedLabel titleImage;
		internal DotNetApi.Windows.Controls.AeroWizard.ThemedImageButton backButton;
